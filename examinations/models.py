...
class Examination(models.Model):
    ...
    doctor = models.ManyToManyField(
        "Doctor", related_name="examinations", null=True, blank=True
    )
    image = models.ImageField(
        null=True, blank=True, upload_to=examination_images_storage
    )
...
class ComputedTomography(Examination):
    doctor = models.ManyToManyField(
        Doctor, related_name="computed_tomography", blank=True, null=True
    )
...
class XRay(Examination):
    doctor = models.ManyToManyField(
        Doctor, related_name="xray", blank=True, null=True
    )
...
class Mammography(Examination):
    doctor = models.ManyToManyField(
        Doctor, related_name="mammography", blank=True, null=True
    )
...
class Ultrasound(Examination):
    doctor = models.ManyToManyField(
        Doctor, related_name="ultrasound", blank=True, null=True
    )
